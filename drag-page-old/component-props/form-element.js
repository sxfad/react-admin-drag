...
import RadioGroup from 'src/pages/drag-page-old/component-style/radio-group';
import UnitInput from 'src/pages/drag-page-old/component-style/unit-input';
import ColorInput from 'src/pages/drag-page-old/component-style/color-input';
import OptionsEditor from 'src/pages/drag-page-old/component-props/options-editor';
import FooterSwitch from './FooterSwitch';
import OffsetInput from 'src/pages/drag-page-old/component-props/offset-input';
import Placement from 'src/pages/drag-page-old/component-props/placement';
import ReactNode from 'src/pages/drag-page-old/component-props/ReactNode';
import MultipleElement from 'src/pages/drag-page-old/component-props/multiple-element';
import ObjectElement from 'src/pages/drag-page-old/component-props/object-element';
import ArrayElement from 'src/pages/drag-page-old/component-props/array-element';
import ImageElement from 'src/pages/drag-page-old/component-props/image-element';
import Rule from 'src/pages/drag-page-old/component-props/item-rules';
import ColumnFastEditor from 'src/pages/drag-page-old/component-props/column-fast-editor';
import FormItemFastEditor from 'src/pages/drag-page-old/component-props/form-item-fast-editor';
