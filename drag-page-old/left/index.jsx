...
import {OTHER_HEIGHT} from 'src/pages/drag-page-old/util';
import DragBar from 'src/pages/drag-page-old/drag-bar';
import styles from './style.less';

export default config({
    connect: state => {
        return {
            showSide: state.dragPageOld.showSide,
            sideWidth: state.dragPageOld.sideWidth,
