...
import {RadioGroup, UnitInput, RectInputsWrapper} from 'src/drag-page/components';
import {handleSyncFields} from '../util';
import s from './style.less';

const displayOptions = [
    {value: 'inline', label: '内联布局', icon: <Icon type="icon-display-inline"/>},
    {value: 'flex', label: '弹性布局', icon: <Icon type="icon-display-flex"/>},
    {value: 'inline-flex', label: '内联弹性布局', icon: <Icon type="icon-display-inline-flex"/>},
    {value: 'block', label: '块级布局', icon: <Icon type="icon-display-block"/>},
    {value: 'inline-block', label: '内联块布局', icon: <Icon type="icon-display-inline-block"/>},
    {value: 'none', label: '内联块布局', icon: <Icon type="icon-display-none"/>},
];
...
const justifyContentOptions = [
    {value: 'flex-start', label: '开始对齐', icon: <Icon type="icon-content-start"/>},
    {value: 'flex-end', label: '结束对齐', icon: <Icon type="icon-content-end"/>},
    {value: 'center', label: '居中', icon: <Icon type="icon-content-center"/>},
    {value: 'space-between', label: '两端对齐', icon: <Icon type="icon-content-between"/>},
    {value: 'space-around', label: '横向平分', icon: <Icon type="icon-content-around"/>},
];
const alignItemsOptions = [
    {value: 'flex-start', label: '上对齐', icon: <Icon type="icon-items-start"/>},
    {value: 'flex-end', label: '下对齐', icon: <Icon type="icon-items-end"/>},
    {value: 'center', label: '居中', icon: <Icon type="icon-items-center"/>},
    {value: 'baseline', label: '基线对齐', icon: <Icon type="icon-items-baseline"/>},
    {value: 'stretch', label: '沾满容器', icon: <Icon type="icon-items-stretch"/>},
];
