...
import {showFieldByAppend} from 'src/drag-page/component-config';
import {getLabelWidth} from 'src/drag-page/util';
                ...
                return (
                    <Col key={category} span={24}>
                        <div className={s.category}>
                            <div className={s.label} style={{flex: `0 0 ${labelCol.flex}`}}>
                                {category}
                            </div>
