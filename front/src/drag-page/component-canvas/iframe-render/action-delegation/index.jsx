...
import {
    ...
    getTargetNode,
    usePageConfigChange,
    useNodeChange, isInputActive,
} from 'src/drag-page/util';
import {findNodeById} from 'src/drag-page/util/node-util';
...
export default React.memo(function DragDelegation(props) {
    ...
    useEffect(() => {
        ...
        function handleSpaceDown(e) {
            if (isInputActive(canvasDocument)) return;
            ...
            coverELe.style.background = 'rgba(255, 0, 0, .05)';
