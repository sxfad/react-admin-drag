...
import {copyTextToClipboard, getNodeByImage, getNodeByText} from 'src/pages/drag-page/util';
import {message} from 'antd';
import {setNodeId} from 'src/pages/drag-page/util/node-util';
import {panes} from 'src/pages/drag-page/props-pane';
import {panes as componentPanes} from 'src/pages/drag-page/component-pane';
...
export default config({
    ...
    const isInputActive = useCallback(() => {
        const isActive = (doc) => {
            ...
            return tagNames.includes(doc.activeElement.tagName);
        };

        return isActive(document) || isActive(canvasDocument);
