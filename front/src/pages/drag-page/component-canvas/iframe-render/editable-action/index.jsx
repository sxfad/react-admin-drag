            ...
            editableContents.forEach(item => {
                ...
                if (selector) {
                    if (typeof selector === 'function') {
                        elements = canvasDocument.querySelectorAll(selector({node, pageConfig}));
                    } else {
                        elements = canvasDocument.querySelectorAll(`.${className} ${selector}`);
                    }
                } else {
                    elements = canvasDocument.querySelectorAll(`.${className}`);
                }
