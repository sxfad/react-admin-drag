...
import {scrollElement} from 'src/pages/drag-page-old/util';
import {loopNode} from 'src/pages/drag-page-old/node-util';
...
import {getComponentConfig} from 'src/pages/drag-page-old/component-config';
...
export default config({
    ...
    connect: state => {
        return {
            ...
            nodeSelectType: state.dragPageOld.nodeSelectType,
            activeSideKey: state.dragPageOld.activeSideKey,
            draggingNode: state.dragPageOld.draggingNode,
            canvasWidth: state.dragPageOld.canvasWidth,
            canvasHeight: state.dragPageOld.canvasHeight,
            canvasScale: state.dragPageOld.canvasScale,
            contentEditable: state.dragPageOld.contentEditable,
        };
    },
