...
import {OTHER_HEIGHT /*, scrollElement*/} from 'src/pages/drag-page-old/util';
import {isNode} from 'src/pages/drag-page-old/node-util';
import CodeEditor from 'src/pages/drag-page-old/component-props/code-editor';
...
export default config({
    connect: state => {
        return {
            ...
            rightSideWidth: state.dragPageOld.rightSideWidth,
        };
    },
